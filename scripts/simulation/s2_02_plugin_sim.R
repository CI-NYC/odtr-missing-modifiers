...
pseudo_cate <- function(newdata) {
  ...
  psi_v21 <- hbar_1_v21 - hbar_0_v21
  psi_v20 <- hbar_1_v20 - hbar_0_v20
  
  newdata$V2*psi_v21 + (1 - newdata$V2)*psi_v20
}

res <- expand.grid(V1_1 = 0:1, V1_2 = 0:1, V1_3 = 0:1, V2 = 0:1)
res$pseudo_cate <- pseudo_cate(res)

saveRDS(res, glue("../../data/sim/sim_pluginNumerator_dag2_{n}_{id}.rds"))
